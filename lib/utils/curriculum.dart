  ...
  static const List<Map<String, dynamic>> worlds = [
    {
      ...
      'skills': [
        ...
        {
          'id': 'sk_sub20',
          'label': 'Soustractions ≤ 20',
          'period': 'P1',
          'level': 'CE1'
        },
        {
          'id': 'sk_sub100',
          'label': 'Soustractions ≤ 100',
          'period': 'P2',
          'level': 'CE1'
        },
        {
    ...
    },
    {
      ...
      'skills': [
        {
          'id': 'sk_read_simple',
          'label': 'Lire des phrases simples',
          'period': 'P1',
          'level': 'CE1'
        },
        {
        ...
        {
          'id': 'sk_read_long',
          'label': 'Texte narratif long',
          'period': 'P1',
          'level': 'CE2'
        },
        {
          'id': 'sk_read_poetry',
          'label': 'Poésie et comptines',
          'period': 'P3',
          'level': 'CE1'
        },
        {
          'id': 'sk_read_infer',
          'label': 'Inférer (implicite)',
          'period': 'P4',
          'level': 'CE2'
        },
      ],
    },
    {
      ...
      'skills': [
        ...
        {
          'id': 'sk_spell_accents',
          'label': 'Accents et tirét',
          'period': 'P2',
          'level': 'CE1'
        },
        {
          'id': 'sk_spell_homophones',
          'label': 'Homophones a/à et/est',
          'period': 'P3',
          'level': 'CE1'
        },
        {
          'id': 'sk_spell_pluriel',
          'label': 'Pluriel en -s / -x',
          'period': 'P3',
          'level': 'CE1'
        },
        {
          'id': 'sk_spell_ce2',
          'label': 'Mots usuels CE2',
          'period': 'P1',
          'level': 'CE2'
        },
      ],
    ...
    },
    {
      ...
      'skills': [
        {
          'id': 'sk_conj_present',
          'label': 'Présent verbes reguliers',
          'period': 'P1',
          'level': 'CE1'
        },
        {
          'id': 'sk_conj_etre_avoir',
          'label': 'Être et avoir au présent',
          'period': 'P1',
          'level': 'CE1'
        },
        {
