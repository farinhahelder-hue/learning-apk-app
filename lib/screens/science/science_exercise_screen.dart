...
class _ScienceExerciseScreenState extends State<ScienceExerciseScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: calm ? const BoxDecoration(gradient: AppTheme.calmScienceGradient) : null,
        child: Stack(
          children: [
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            TextButton(onPressed: () => Navigator.pop(context), child: const Text('Retour à la carte')),
          ],
        ),
      ),
    );
