...
class ActiveBreakScreen extends StatefulWidget {
  ...
  @override State<ActiveBreakScreen> createState() => _ActiveBreakScreenState();
}
  ...
  static const List<Map<String, dynamic>> _activities = [
    {
      ...
      'instruction': 'Regarde au loin à travers la fenêtre pendant 20 secondes.\nLaisse tes yeux se reposer de l’écran.',
      'duration': 20,
      'color': 0xFF4FC3F7,
    },
    {
      ...
      'instruction': 'Fais 10 sauts sur place !\n1, 2, 3... allez, tu peux le faire !',
      'duration': 15,
      'color': 0xFF81C784,
    },
    {
      ...
      'instruction': 'Inspire lentement (4 secondes)...\nBloque (2 secondes)...\nExpire doucement (4 secondes).\nRecommence 3 fois.',
      'duration': 30,
      'color': 0xFFBA68C8,
    },
    {
      ...
      'instruction': 'Va dans ta chambre et trouve :\n■ Un objet carré\n▲ Un objet triangulaire\n● Un objet rond',
      'duration': 45,
      'color': 0xFFFFB74D,
    },
    {
      ...
      'instruction': 'Danse et épelle ton prénom lettre par lettre !\nE - M - I - L - I - E !',
      'duration': 20,
      'color': 0xFFFF80AB,
    },
    {
  ...
  void _startCountdown() {
    ...
    _timer = Timer.periodic(const Duration(seconds: 1), (t) {
      if (_countdown > 1) {
        ...
        t.cancel();
        setState(() { _countdown = 0; _canContinue = true; });
      }
    });
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(act['emoji'] as String, style: const TextStyle(fontSize: 100))
                ...
                Container(
                  ...
                  child: Text(act['instruction'] as String,
                      style: const TextStyle(fontSize: 17, color: Colors.white, height: 1.6),
                      textAlign: TextAlign.center),
                ),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: List.generate(_activities.length, (i) => Container(
                    margin: const EdgeInsets.symmetric(horizontal: 4),
                    width: i == _currentActivity ? 24 : 8,
                    height: 8,
                    decoration: BoxDecoration(
                      color: i <= _currentActivity ? Colors.white : Colors.white.withOpacity(0.4),
