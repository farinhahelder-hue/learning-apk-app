...
class NumberBarsData {
  ...
  static const List<NumberBarsMission> ce1 = [
    ...
    NumberBarsMission(
      ...
      competence: 'composer_nombres_jusqua_100',
      missionType: 'Je réussis',
      objective: 'Construis le nombre 90',
      target: 90,
      hints: [
        '90, c\'est 9 dizaines et aucune unité.',
        'Le zéro des unités : on ne met aucun petit cube.',
        'Mets 9 barres de dizaines.',
      ],
    ),
    NumberBarsMission(
      id: 'nb_ce1_08',
      ...
      competence: 'grouper_dix_unites_en_dizaine',
      missionType: 'Je consolide',
      objective: 'Construis le nombre 30',
      target: 30,
      hints: [
        '30, c\'est 3 dizaines.',
        'Essaie avec 10 cubes : ils se regroupent en 1 barre.',
        'Recommence trois fois, ou mets 3 barres d\'un coup.',
      ],
    ),
    NumberBarsMission(
      id: 'nb_ce1_09',
      ...
      competence: 'grouper_dix_unites_en_dizaine',
      missionType: 'Je réussis',
      objective: 'Construis le nombre 100',
      target: 100,
      hints: [
        '100, c\'est 1 centaine.',
        '10 barres de dizaines se regroupent en 1 plaque de centaine !',
        'Tu peux aussi mettre directement 1 plaque.',
      ],
    ),
  ];
  ...
  static const List<NumberBarsMission> ce2 = [
    ...
    NumberBarsMission(
      ...
      competence: 'valeur_position_chiffre',
      missionType: 'Je découvre',
      objective: 'Construis le nombre 2 200',
      target: 2200,
      hints: [
        'Il y a deux fois le chiffre 2, mais ils ne valent pas pareil.',
        'Le premier 2 vaut 2 milliers, le second vaut 2 centaines.',
        'Mets 2 cubes de milliers et 2 plaques de centaines.',
      ],
    ),
    NumberBarsMission(
      id: 'nb_ce2_08',
      ...
      competence: 'valeur_position_chiffre',
      missionType: 'Je consolide',
      objective: 'Construis le nombre 3 033',
      target: 3033,
      hints: [
        'Le chiffre 3 apparaît trois fois, à trois places différentes.',
        '3 milliers, 0 centaine, 3 dizaines et 3 unités.',
        'La colonne des centaines reste vide.',
      ],
    ),
    NumberBarsMission(
      id: 'nb_ce2_09',
      ...
      competence: 'grouper_dix_unites_en_dizaine',
      missionType: 'Je consolide',
      objective: 'Construis le nombre 2 000',
      target: 2000,
      hints: [
        '2 000, c\'est 2 milliers.',
        'Chaque groupe de 10 plaques devient 1 cube de millier.',
        'Tu peux aussi mettre directement 2 cubes de milliers.',
      ],
    ),
    NumberBarsMission(
      id: 'nb_ce2_10',
      ...
      competence: 'grouper_dix_unites_en_dizaine',
      missionType: 'Je réussis',
      objective: 'Construis le nombre 1 100',
      target: 1100,
      hints: [
        '1 100, c\'est 1 millier et 1 centaine.',
        'Attention : ce n\'est pas 11 centaines toutes seules.',
        'Mets 1 cube de millier, puis 1 plaque de centaine.',
      ],
    ),
  ];
}
