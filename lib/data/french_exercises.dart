...
class FrenchExercises {
  ...
  static const List<Exercise> _all = [
    ...
    Exercise(
        ...
        points: 15,
        mascot: Mascot.seal,
        hint: "C'est un animal qui fait \"miaou\""),
    Exercise(
        id: 'ecriture_2',
        subject: 'french',
        type: 'writing',
    ...
    Exercise(
        ...
        type: 'qcm',
        question:
            'Lis : "Marie lit un livre rouge" - Quelle est la couleur du livre ?',
    ...
    Exercise(
        ...
        displayWord: 'p _ n g _ _ _ n',
        correctAnswer: 'pingouin',
        difficulty: 2,
        points: 20,
        mascot: Mascot.squirrel,
        hint: 'PINGOUIN'),
    ...
    Exercise(
        ...
        phoneticTarget: 'syllables',
        correctAnswer: '5',
        difficulty: 2,
        points: 20,
        mascot: Mascot.jellyfish,
        audioWord: 'hippopotame'),
    Exercise(
        id: 'phonetique_4',
        subject: 'french',
        type: 'phonetic',
    ...
    Exercise(
        ...
        type: 'qcm',
        question:
            'Mots 24 bleu - 1/4 : Quel est le bon mot ? "Le ___ a chanté toute la nuit." (oiseau/oiseau)',
    ...
    Exercise(
        ...
        type: 'qcm',
        question:
            'Mots 24 bleu - 2/4 : Quel est le bon mot ? "J\'ai ___ à la campagne." (allé/alé)',
        options: ['alé', 'allé', 'allez', 'alée'],
        correctAnswer: 'allé',
        difficulty: 1,
        points: 10,
        mascot: Mascot.seal,
        hint: 'Aller au passé composé : j\'ai allé... NON ! j\'ai ALLÉ'),
    Exercise(
        id: 'mots24_3',
        subject: 'french',
        type: 'qcm',
        question:
            'Mots 24 bleu - 3/4 : Quel mot prend un accent ? "Le petit ___ vole dans le ciel." (herisson/hérisson)',
        options: ['herisson', 'hérisson', 'hérisson', 'herisson'],
        correctAnswer: 'hérisson',
        difficulty: 2,
        points: 15,
        mascot: Mascot.seal,
        hint: 'HÉRISSON = accent sur le E'),
    Exercise(
        id: 'mots24_4',
        subject: 'french',
        type: 'qcm',
        question:
            'Mots 24 bleu - 4/4 : "Un ___ de beurre" - Quel mot complète la phrase ? (morceau/morço)',
        options: ['morço', 'morceau', 'morçau', 'morso'],
        correctAnswer: 'morceau',
        difficulty: 2,
        points: 15,
        mascot: Mascot.seal,
        hint: 'MORCEAU = un bout, un fragment'),
    ...
    Exercise(
        ...
        type: 'qcm',
        question:
            'Mots 24 bleu - 5/8 : Complète : "La ___ est pleine de étoiles." (nüe/nuit)',
        options: ['nüe', 'nuitt', 'nuit', 'nuitte'],
        correctAnswer: 'nuit',
        difficulty: 1,
        points: 10,
        mascot: Mascot.squirrel,
        hint: 'La NUIT tombe quand le soleil se couche'),
    Exercise(
        id: 'mots24_6',
        subject: 'french',
        type: 'qcm',
        question:
            'Mots 24 bleu - 6/8 : Complète : "Mon ___ s\'appelle Léo." (chatchat/chien)',
        options: ['chat', 'chatchat', 'chats', 'chatt'],
        correctAnswer: 'chat',
        difficulty: 1,
        points: 10,
        mascot: Mascot.squirrel,
        hint: 'Animal qui fait "miaou"'),
    Exercise(
        id: 'mots24_7',
        subject: 'french',
        type: 'qcm',
        question:
            'Mots 24 bleu - 7/8 : Complète : "Le ___ est rouge." (soré/soir)',
        options: ['soir', 'soré', 'sware', 'soirr'],
        correctAnswer: 'soir',
        difficulty: 1,
        points: 10,
        mascot: Mascot.squirrel,
        hint: 'Le SOIR, le soleil se couche'),
    Exercise(
        id: 'mots24_8',
        subject: 'french',
        type: 'qcm',
        question:
            'Mots 24 bleu - 8/8 : Complète : "Le ___ a chanté ce matin." (oijoiseau/oiseau)',
    ...
    Exercise(
        ...
        type: 'qcm',
        question:
            'Mots 24 bleu - Phonétique 1 : Quel mot contient le son [wa] ?',
        options: ['loin', 'lion', 'lundi', 'lampe'],
        correctAnswer: 'loin',
        difficulty: 2,
        points: 15,
        mascot: Mascot.jellyfish,
        hint: 'LOIN = L + OIN (son [wa])'),
    Exercise(
        id: 'mots24_10',
        subject: 'french',
        type: 'qcm',
        question:
            'Mots 24 bleu - Phonétique 2 : Quel mot contient le son [wɑ̃] ?',
        options: ['maison', 'montagne', 'bonbon', 'vingt'],
        correctAnswer: 'vingt',
        difficulty: 2,
        points: 15,
        mascot: Mascot.jellyfish,
        hint: 'VINGT = son [wɑ̃] nasal'),
    ...
    Exercise(
        ...
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 1 : Écris le mot "hiver" (la saison froide)',
        prompt: 'Écris : hiver',
        correctAnswer: 'hiver',
        difficulty: 1,
        points: 15,
    ...
    Exercise(
        ...
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 2 : Écris le mot "forêt" (lieu avec beaucoup d\'arbres)',
        prompt: 'Écris : forêt',
        correctAnswer: 'forêt',
        difficulty: 2,
        points: 20,
        mascot: Mascot.seal,
        hint: 'F-O-R-Ê-T (accent sur le E)'),
    Exercise(
        id: 'mots24_13',
        subject: 'french',
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 3 : Écris le mot "noix" (fruit de l\'arbre)',
        prompt: 'Écris : noix',
        correctAnswer: 'noix',
        difficulty: 1,
        points: 15,
    ...
    Exercise(
        ...
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 4 : Écris le mot "mur" (dans une maison)',
        prompt: 'Écris : mur',
        correctAnswer: 'mur',
        difficulty: 1,
        points: 15,
    ...
    Exercise(
        ...
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 5 : Écris le mot "doux" (pas dur, pas méchant)',
        prompt: 'Écris : doux',
        correctAnswer: 'doux',
        difficulty: 1,
        points: 15,
    ...
    Exercise(
        ...
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 6 : Écris le mot "travail" (ce qu\'on fait pour gagner sa vie)',
        prompt: 'Écris : travail',
    ...
    Exercise(
        ...
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 7 : Écris le mot "écureuil" (petit animal roux avec une grande queue)',
        prompt: 'Écris : écureuil',
        correctAnswer: 'écureuil',
        difficulty: 3,
        points: 25,
        mascot: Mascot.seal,
        hint: 'É-C-U-R-E-U-I-L (accents!)'),
    Exercise(
        id: 'mots24_18',
        subject: 'french',
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 8 : Écris le mot "fenêtre" (pour voir dehors)',
        prompt: 'Écris : fenêtre',
    ...
    Exercise(
        ...
        type: 'qcm',
        question:
            'Mots 24 bleu - 9/12 : Quel est le bon mot ? "Le ___ a des épines." (rose/rôse)',
        options: ['rôse', 'rose', 'roze', 'rôsse'],
        correctAnswer: 'rose',
        difficulty: 1,
        points: 10,
        mascot: Mascot.seal,
        hint: 'La ROSE est une fleur'),
    Exercise(
        id: 'mots24_20',
        subject: 'french',
        type: 'qcm',
        question:
            'Mots 24 bleu - 10/12 : Quel mot prend un accent ? "Le ___ est jaune." (soleil/soléil)',
        options: ['soléil', 'soleil', 'soli', 'soleil'],
        correctAnswer: 'soleil',
        difficulty: 1,
        points: 10,
        mascot: Mascot.seal,
        hint: 'SOLEIL = grand O, pas d\'accent'),
    Exercise(
        id: 'mots24_21',
        subject: 'french',
        type: 'qcm',
        question:
            'Mots 24 bleu - 11/12 : Complète : "Le ___ est un fruit rouge." (fraise/fèrèse)',
        options: ['fèrèse', 'fraisse', 'fraise', 'frèse'],
        correctAnswer: 'fraise',
        difficulty: 1,
        points: 10,
        mascot: Mascot.squirrel,
        hint: 'La FRAISE = F-R-A-I-S-E'),
    Exercise(
        id: 'mots24_22',
        subject: 'french',
        type: 'qcm',
        question:
            'Mots 24 bleu - 12/12 : Quel mot est correct ? "La ___ est noire." (nüit/nuit)',
        options: ['nüe', 'nuitt', 'nuit', 'nuitte'],
        correctAnswer: 'nuit',
        difficulty: 1,
        points: 10,
        mascot: Mascot.squirrel,
        hint: 'La NUIT = N-U-I-T'),
    ...
    Exercise(
        ...
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 9 : Écris le mot "plage" (lieu au bord de la mer)',
        prompt: 'Écris : plage',
        correctAnswer: 'plage',
        difficulty: 1,
        points: 15,
    ...
    Exercise(
        ...
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 10 : Écris le mot "village" (petit village)',
        prompt: 'Écris : village',
    ...
    Exercise(
        ...
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 11 : Écris le mot "nuage" (dans le ciel)',
        prompt: 'Écris : nuage',
        correctAnswer: 'nuage',
        difficulty: 1,
        points: 15,
    ...
    Exercise(
        ...
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 12 : Écris le mot "sorcière" (personnage de conte)',
        prompt: 'Écris : sorcière',
        correctAnswer: 'sorcière',
        difficulty: 3,
        points: 25,
        mascot: Mascot.seal,
        hint: 'S-O-R-C-I-È-R-E (accent!)'),
    Exercise(
        id: 'mots24_27',
        subject: 'french',
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 13 : Écris le mot "sèvre" (rivière en France)',
        prompt: 'Écris : siège',
        correctAnswer: 'siège',
        difficulty: 2,
        points: 20,
    ...
    Exercise(
        ...
        type: 'writing',
        question:
            'Mots 24 bleu - Dictée 14 : Écris le mot "cinquante" (5 × 10)',
        prompt: 'Écris : cinquante',
        correctAnswer: 'cinquante',
        difficulty: 2,
        points: 20,
        mascot: Mascot.seal,
        hint: 'C-I-N-Q-U-A-N-T-E'),
    ...
    Exercise(
        ...
        correctAnswer: 'moineau',
        difficulty: 2,
        points: 15,
        mascot: Mascot.jellyfish,
        hint: 'MOINEAU = M + OIN +EAU (son [wa])'),
    Exercise(
        id: 'mots24_30',
        subject: 'french',
        type: 'qcm',
        ...
        correctAnswer: 'ecureuil',
        difficulty: 2,
        points: 15,
        mascot: Mascot.jellyfish,
        hint: 'ECUREUIL a besoin d\'accents : É-C-U-R-E-U-I-L'),
  ];
}
