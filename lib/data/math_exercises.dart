...
class MathExercises {
  ...
  static const List<Exercise> _all = [
    ...
    // ============================================================
    Exercise(
      id: 'numeration_1', subject: 'math', type: 'qcm',
      question: 'Quel nombre est égal à 3 milliers + 4 centaines + 5 dizaines + 2 unités ?',
      options: ['3425', '3452', '3245', '3542'], correctAnswer: '3452',
      difficulty: 2, points: 15,
      hint: '3 000 + 400 + 50 + 2 = ?'
    ),
    Exercise(
      id: 'numeration_2', subject: 'math', type: 'qcm',
      question: 'Comment écrit-on "deux mille quatre cent dix-sept" en chiffres ?',
      options: ['2417', '24017', '20417', '24170'], correctAnswer: '2417',
      difficulty: 2, points: 15,
      hint: '2 000 + 400 + 10 + 7'
    ),
    Exercise(
      id: 'numeration_3', subject: 'math', type: 'qcm',
      question: 'Le nombre 5 738 a quel chiffre des centaines ?',
      options: ['5', '7', '3', '8'], correctAnswer: '7',
      difficulty: 2, points: 15,
      hint: '5 7 3 8 = 5 milliers, 7 centaines, 3 dizaines, 8 unités'
    ),
    Exercise(
      id: 'numeration_4', subject: 'math', type: 'qcm',
      question: 'Compare : 4 502 ___ 4 520',
      options: ['<', '>', '=', '≈'], correctAnswer: '<',
      difficulty: 2, points: 15,
      hint: '502 est plus petit que 520'
    ),
    Exercise(
      id: 'numeration_5', subject: 'math', type: 'qcm',
      question: 'Range ces nombres du plus petit au plus grand : 2345, 2543, 2435, 2354',
      options: [
        '2345, 2354, 2435, 2543',
        '2543, 2435, 2354, 2345',
        '2345, 2435, 2354, 2543',
    ...
    Exercise(
      id: 'numeration_6', subject: 'math', type: 'qcm',
      question: 'Le nombre qui vient juste avant 4 000 est :',
      options: ['3999', '3990', '4001', '3998'], correctAnswer: '3999',
      difficulty: 2, points: 15,
      hint: '4 000 - 1 = ?'
    ),
    Exercise(
      id: 'numeration_7', subject: 'math', type: 'qcm',
      question: 'Le nombre 8 291 est composé de :',
      options: [
    ...
    Exercise(
      id: 'numeration_8', subject: 'math', type: 'qcm',
    ...
    Exercise(
      id: 'numeration_9', subject: 'math', type: 'qcm',
      question: 'Encadre 2 580 entre les centaines les plus proches :',
      options: [
        '2 500 et 2 600',
        '2 580 et 2 590',
        '2 000 et 3 000',
    ...
    Exercise(
      id: 'numeration_10', subject: 'math', type: 'qcm',
      question: 'Combien de chiffres a le nombre "six mille huit cent quarante-trois" ?',
      options: ['3', '4', '5', '6'], correctAnswer: '4',
      difficulty: 2, points: 15,
      hint: '6 8 4 3 = 4 chiffres'
    ),
    Exercise(
      id: 'numeration_11', subject: 'math', type: 'qcm',
      question: 'Dans 7 654, le chiffre 6 représente :',
    ...
    Exercise(
      id: 'numeration_12', subject: 'math', type: 'qcm',
      question: '3 000 + 500 + 40 + 9 = ?',
