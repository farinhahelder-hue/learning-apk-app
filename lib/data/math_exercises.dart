...
class MathExercises {
  ...
  static const List<Exercise> _all = [
    ...
    Exercise(
        ...
        subject: 'math',
        type: 'qcm',
        question: 'Quel nombre manque ? 14 + __ = 21',
        options: ['5', '6', '7', '8'],
        correctAnswer: '7',
        difficulty: 2,
        points: 15),
    ...
    Exercise(
        ...
        subject: 'math',
        type: 'qcm',
        question: 'J’ai 13 bonbons et j’en reçois 9. Combien en ai-je ?',
        options: ['20', '21', '22', '23'],
        correctAnswer: '22',
        difficulty: 2,
        points: 15),
    ...
    Exercise(
        ...
        subject: 'math',
        type: 'qcm',
        question: 'Quel nombre manque ? 30 - __ = 14',
        options: ['14', '15', '16', '17'],
        correctAnswer: '16',
        difficulty: 2,
        points: 15),
    ...
    Exercise(
        ...
        subject: 'math',
        type: 'qcm',
        question: 'Quelle forme est ronde ?',
    ...
    Exercise(
        ...
        subject: 'math',
        type: 'qcm',
        question: 'Un rectangle a combien de côtés ?',
        options: ['3', '4', '5', '6'],
        correctAnswer: '4',
        difficulty: 1,
        points: 10),
    Exercise(
        ...
        options: ['Pentagone', 'Hexagone', 'Carré', 'Triangle'],
    ...
    Exercise(
        ...
        subject: 'math',
        type: 'qcm',
        question: 'Quel est la moitié de 20 ?',
        options: ['8', '9', '10', '11'],
        correctAnswer: '10',
        difficulty: 2,
        points: 15),
    ...
    Exercise(
        ...
        type: 'qcm',
        question:
            'Num 13 - Exercice 1 : Quel nombre est égal à 3 milliers + 4 centaines + 5 dizaines + 2 unités ?',
        options: ['3425', '3452', '3245', '3542'],
        correctAnswer: '3452',
        difficulty: 2,
        points: 15,
        hint: '3 000 + 400 + 50 + 2 = ?'),
    Exercise(
        ...
        type: 'qcm',
        question:
            'Num 13 - Exercice 2 : Comment écrit-on "deux mille quatre cent dix-sept" en chiffres ?',
        options: ['2417', '24017', '20417', '24170'],
        correctAnswer: '2417',
        difficulty: 2,
        points: 15,
        hint: '2 000 + 400 + 10 + 7'),
    Exercise(
        ...
        type: 'qcm',
        question:
            'Num 13 - Exercice 3 : Le nombre 5 738 a quel chiffre des centaines ?',
        options: ['5', '7', '3', '8'],
        correctAnswer: '7',
        difficulty: 2,
        points: 15,
    ...
    Exercise(
        ...
        type: 'qcm',
        question:
            'Num 13 - Exercice 5 : Range ces nombres du plus petit au plus grand : 2345, 2543, 2435, 2354',
        options: [
          '2345, 2354, 2435, 2543',
          '2543, 2435, 2354, 2345',
          '2345, 2435, 2354, 2543',
    ...
    Exercise(
        ...
        type: 'qcm',
        question:
            'Num 13 - Exercice 6 : Le nombre qui vient juste avant 4 000 est :',
        options: ['3999', '3990', '4001', '3998'],
        correctAnswer: '3999',
        difficulty: 2,
        points: 15,
        hint: '4 000 - 1 = ?'),
    ...
    Exercise(
        ...
        type: 'qcm',
        question:
            'Num 13 - Exercice 9 : Encadre 2 580 entre les centaines les plus proches :',
        options: [
          '2 500 et 2 600',
          '2 580 et 2 590',
          '2 000 et 3 000',
    ...
    Exercise(
        ...
        type: 'qcm',
        question:
            'Num 13 - Exercice 10 : Combien de chiffres a le nombre "six mille huit cent quarante-trois" ?',
        options: ['3', '4', '5', '6'],
        correctAnswer: '4',
        difficulty: 2,
        points: 15,
    ...
    Exercise(
        ...
        type: 'qcm',
        question:
            'Num 13 - Exercice 11 : Dans 7 654, le chiffre 6 représente :',
