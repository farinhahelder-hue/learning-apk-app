...
class StoryChapter {
  ...
  const StoryChapter({
    ...
    required this.narrative, required this.worldId, required this.skillId,
    required this.requiredStars, required this.rewardText, required this.rewardEmoji,
  });
}
...
class Story {
  static const List<StoryChapter> chapters = [
    StoryChapter(
      ...
      worldId: 'math_numbers', skillId: 'sk_add20',
      requiredStars: 0,
      rewardText: 'Bravo ! Les petits nombres sont libérés ! Émilie repart avec +1 pouvoir mathématique !',
      rewardEmoji: '🔢',
    ),
    StoryChapter(
      id: 'ch2',
      ...
      emoji: '🌲',
      narrative:
          'La forêt magique a perdu tous ses mots !\n'
      ...
      worldId: 'french_spelling', skillId: 'sk_spell_basic',
      requiredStars: 3,
      rewardText: 'La forêt chante à nouveau ! Tu as retrouvé 100 mots magiques !',
      rewardEmoji: '🌳',
    ),
    StoryChapter(
      id: 'ch3',
      ...
      emoji: '📍',
      narrative:
          'La Tour du Savant Géomètre s’est effondrée !\n'
          'Carrés, triangles et cercles sont mélangés partout dans la ville.\n'
          '📜 Mission : Reconnais les formes pour reconstruire la Tour !',
      worldId: 'math_geometry', skillId: 'sk_shapes2d',
      requiredStars: 6,
      rewardText: 'La Tour est reconstruite ! Émilie est nommée Architecte du Royaume !',
      rewardEmoji: '🏛️',
    ),
    StoryChapter(
      id: 'ch4',
      ...
      worldId: 'french_grammar', skillId: 'sk_gram_phrase',
      requiredStars: 10,
      rewardText: 'Le dragon est dompté ! Il t’obéit maintenant et récite des poèmes !',
      rewardEmoji: '🐉',
    ),
    StoryChapter(
      id: 'ch5',
      ...
      worldId: 'math_measures', skillId: 'sk_money',
      requiredStars: 15,
      rewardText: 'Le trésor est à toi ! Et dedans… un parchemin avec la prochaine aventure !',
      rewardEmoji: '🗃️',
    ),
    StoryChapter(
      id: 'ch6',
      ...
      emoji: '⏰',
      narrative:
          'La machine à remonter le temps est bloquée !\n'
      ...
      worldId: 'french_conjugation', skillId: 'sk_conj_present',
      requiredStars: 20,
      rewardText: 'La machine est réparée ! Tu peux voyager dans le temps... et en CE2 !',
      rewardEmoji: '⌛',
    ),
  ];
